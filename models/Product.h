...
class Product
{
  public:
    struct Cols
    {
        ...
        static const std::string _available_listing;
        static const std::string _sales_volume;
    };
    ...
    /**  For column available_listing  */
    ///Get the value of the column available_listing, returns the default value if the column is null
    const int8_t &getValueOfAvailableListing() const noexcept;
    ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
    const std::shared_ptr<int8_t> &getAvailableListing() const noexcept;
    ///Set the value of the column available_listing
    void setAvailableListing(const int8_t &pAvailableListing) noexcept;

    /**  For column sales_volume  */
    ///Get the value of the column sales_volume, returns the default value if the column is null
    const int32_t &getValueOfSalesVolume() const noexcept;
    ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
    const std::shared_ptr<int32_t> &getSalesVolume() const noexcept;
    ///Set the value of the column sales_volume
    void setSalesVolume(const int32_t &pSalesVolume) noexcept;
  ...
  private:
    ...
    std::shared_ptr<int8_t> availableListing_;
    std::shared_ptr<int32_t> salesVolume_;
    struct MetaData
    {
